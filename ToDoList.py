...
THEMES = {
    "light": {
        "Matcha & Adaçayı": {
            ...
            "btn_settings": "#B0D2AF", "btn_settings_hover": "#92BF91",
        ...
        "Latte & Şeftali": {
            ...
            "btn_danger": "#E89A9A", "btn_danger_hover": "#DB7E7E",
            "btn_settings": "#F4B392", "btn_settings_hover": "#EC9970",
        ...
        "Lavanta Rüyası": {
            ...
            "btn_danger": "#E89A9A", "btn_danger_hover": "#DB7E7E",
            "btn_settings": "#BEA4EA", "btn_settings_hover": "#A583DF",
        ...
        "Okyanus Esintisi": {
            ...
            "btn_danger": "#E89A9A", "btn_danger_hover": "#DB7E7E",
            "btn_settings": "#6CBDE0", "btn_settings_hover": "#4EAECF",
        ...
        "Sakura & Gül": {
            ...
            "btn_danger": "#E89A9A", "btn_danger_hover": "#DB7E7E",
            "btn_settings": "#EE94B4", "btn_settings_hover": "#E3739B",
        ...
        "Nordik Kar & Sis": {
            ...
            "btn_settings": "#38BDF8", "btn_settings_hover": "#0284C7",
        ...
        "Nane & Ferah Okaliptüs": {
            ...
            "btn_danger": "#E89A9A", "btn_danger_hover": "#DB7E7E",
            "btn_settings": "#2DD4BF", "btn_settings_hover": "#0D9488",
    ...
    "dark": {
        "Gece Yarısı": {
            ...
            "btn_settings": "#0284C7", "btn_settings_hover": "#0369A1",
        ...
        "Karanlık Karbon": {
            ...
            "btn_settings": "#3B82F6", "btn_settings_hover": "#2563EB",
        ...
        "Kuzey Ormanı": {
            ...
            "btn_danger": "#EF4444", "btn_danger_hover": "#DC2626",
            "btn_settings": "#059669", "btn_settings_hover": "#047857",
        ...
        "Espresso & Moka": {
            ...
            "btn_settings": "#C05621", "btn_settings_hover": "#9C4221",
        ...
        "Karanlık Ametist": {
            ...
            "btn_danger": "#E11D48", "btn_danger_hover": "#BE123C",
            "btn_settings": "#7C3AED", "btn_settings_hover": "#6D28D9",
        ...
        "Dracula & Vampir": {
            ...
            "btn_settings": "#BD93F9", "btn_settings_hover": "#A776F6",
        ...
        "Nordik Fiyort & Gece": {
            ...
            "btn_settings": "#00B4D8", "btn_settings_hover": "#0096C7",
        ...
        "Retro Synthwave 80s": {
            ...
            "btn_danger": "#EF4444", "btn_danger_hover": "#DC2626",
            "btn_settings": "#D946EF", "btn_settings_hover": "#C026D3",
...
class StickyWidget(ctk.CTkToplevel):
    """Her zaman üstte duran, kenar çizgisiz, yumuşak yuvarlak pastel kart tarzı lofi mini widget."""
    def __init__(self, parent):
        ...
        self.setup_ui()
        self.bind_events()
        self.after(20, self.apply_round_corners)

    def apply_round_corners(self):
        """Windows SetWindowRgn ile pencereyi pürüzsüz yuvarlak keser (0 çizgi, 0 taşma)."""
        try:
            self.update_idletasks()
            w = self.winfo_width()
            h = self.winfo_height()
            if w <= 10 or h <= 10:
                w, h = 260, 340
            r = 36  # 18px yumuşak köşe yarıçapı
            hwnd_child = self.winfo_id()
            rgn1 = ctypes.windll.gdi32.CreateRoundRectRgn(0, 0, w + 1, h + 1, r, r)
            ctypes.windll.user32.SetWindowRgn(hwnd_child, rgn1, True)

            hwnd_parent = ctypes.windll.user32.GetParent(hwnd_child)
            if hwnd_parent:
                rgn2 = ctypes.windll.gdi32.CreateRoundRectRgn(0, 0, w + 1, h + 1, r, r)
    ...
    def setup_ui(self):
        ...
        # Dış Kart (Kenar çizgisiz, yumuşak pastel kart)
        self.card = ctk.CTkFrame(
            self, fg_color=theme["card"], corner_radius=18,
            border_width=0
        )
        self.card.pack(fill="both", expand=True, padx=0, pady=0)

        # Başlık Çubuğu (Sürüklenebilir, içi yuvarlak kapsül)
        self.header = ctk.CTkFrame(self.card, fg_color=theme["card_alt"], height=36, corner_radius=12)
    ...
    def apply_theme(self):
        theme = self.parent.get_theme()
        self.configure(fg_color=theme["card"])
        self.card.configure(fg_color=theme["card"], border_width=0)
...
def draw_washi_tape_polygon(img, center, length=32, thickness=10, angle_deg=45, color=(238, 185, 145, 215)):
    """Açılı ve yarı şeffaf gerçekçi Washi Tape bandı çizer."""
    ...
    tape_layer = Image.new("RGBA", img.size, (0, 0, 0, 0))
...
def create_tilted_polaroid(img_path, width=125, height=95, angle=0):
    """Resmi polaroid çerçevesi içine oranını bozmadan alır, 4 köşeli washi tape ve doğal bir açıyla döndürür."""
    try:
...
STICKER_CATALOG = {
    "🌸 Çiçek & Doğa": [
        ("Kiraz Çiçeği", "nature_sakura.png"),
        ("Papatya", "nature_daisy.png"),
        ("Mantar", "nature_mushroom.png"),
        ("Dört Yapraklı Yonca", "nature_clover.png"),
        ("Sonbahar Yaprağı", "nature_maple.png"),
        ("Saksı Çiçeği", "nature_plant_pot.png"),
        ("Ayçiçeği", "nature_sunflower.png"),
        ("Lale", "nature_tulip.png"),
        ("Kırmızı Gül", "nature_rose.png"),
        ("Lavanta Demeti", "nature_lavender.png"),
        ("Saksı Kaktüs", "nature_cactus.png"),
        ("Monstera Yaprağı", "nature_monstera.png"),
        ("Sukulent", "nature_succulent.png"),
        ("Meşe Palamudu", "nature_acorn.png"),
        ("Nilüfer Çiçeği", "nature_lotus.png"),
        ("Bambu Filizi", "nature_bamboo.png"),
        ("Çam Kozalağı", "nature_pinecone.png"),
    ...
    "☕ Cozy Kafe, Tatlılar & Meyveler": [
        ...
        ("Kruvasan", "cafe_croissant.png"),
        ("Pankek", "cafe_pancake.png"),
        ...
        ("Donut", "cafe_donut.png"),
        ("Dondurmalı Waffle", "cafe_waffle.png"),
        ("Karpuz Dilimi", "fruit_watermelon.png"),
        ("Çizburger", "cafe_burger.png"),
    ...
    "🐾 Sevimli Hayvan Dostlar": [
        ...
        ("Sevimli Hamster", "animal_hamster.png"),
        ("Tatlı Kirpi", "animal_hedgehog.png"),
        ("Su Samuru", "animal_otter.png"),
        ("Bebek Koala", "animal_koala.png"),
        ("Kabarık Sincap", "animal_squirrel.png"),
        ("Beyaz Fok", "animal_seal.png"),
        ("Yavru Kaplumbağa", "animal_turtle.png"),
        ("Yünlü Alpaka", "animal_alpaca.png"),
    ...
    "📚 Çalışma, Kırtasiye & Lofi": [
        ...
        ("Lofi Kulaklık", "study_headphones.png"),
        ("Boya Kalemleri", "study_colored_pencils.png"),
        ("Ahşap Cetvel & Gönye", "study_ruler.png"),
        ("El İşi Makası", "study_scissors.png"),
        ("Renkli Ataşlar", "study_paperclip.png"),
        ("Yapışkan Not (Post-it)", "study_sticky_note.png"),
        ("Washi Tape Bant", "study_washi_tape.png"),
        ("Suluboya Fırçası", "study_paintbrush.png"),
        ("Sevimli Silgi", "study_eraser.png"),
        ("Spiralli Ajanda", "study_planner.png"),
        ("Pembe Kum Saati", "study_hourglass.png"),
    ...
    "🌙 Gece, Kozmik & Sevimli Çizimler": [
        ...
        ("Kayan Yıldız", "cosmic_shooting_star.png"),
        ("Gözlüklü Güneş", "cosmic_sun.png"),
        ("Gökkuşağı Kristal", "cosmic_crystal.png"),
        ("Uzay Roketi", "cosmic_rocket.png"),
        ("Pastel Uçan Daire", "cosmic_ufo.png"),
        ("Şanslı Origami Yıldız", "cosmic_lucky_star.png"),
        ("Kalp Balon", "doodle_balloon.png"),
...
class DailyNoteModal(ctk.CTkToplevel):
    ...
    def setup_ui(self):
        ...
        for w in [self.outer_frame, head]:
            try:
        ...
        # 5. Alt Butonlar (Sayfayı Kaydet / Notu Sil - Sadece bugünün sayfasında)
        if self.is_today:
    ...
    def _show_sticker_controls(self, s, sw, sh):
        ...
        self.canvas.create_oval(tr_x - r, tr_y - r, tr_x + r, tr_y + r,
                                fill="#EF4444", outline="#DC2626", width=1, tags=("stk_ctrl", "stk_del", "stk_del_oval"))
        self.canvas.create_text(tr_x, tr_y, text="✕", font=("Segoe UI", 7, "bold"),
                                fill="#FFFFFF", tags=("stk_ctrl", "stk_del", "stk_del_txt"))

        # 2. Sol Üst: Mavi Döndür (🔄 - Basılı Tutup Çevir)
        self.canvas.create_oval(tl_x - r, tl_y - r, tl_x + r, tl_y + r,
                                fill="#3B82F6", outline="#2563EB", width=1, tags=("stk_ctrl", "stk_rot", "stk_rot_oval"))
        ...
        def _start_stk_rot(e):
            self._rot_start_x = e.x_root
            self._rot_start_item_angle = s.get("angle", 0)
            self._is_rotating = True
            self._active_hover_item = {"type": "sticker", "data": s}
    ...
    def _show_polaroid_controls(self, item, pw, ph):
        ...
        # 1. Sağ Üst: Kırmızı Sil (✕)
        self.canvas.create_oval(tr_x - r, tr_y - r, tr_x + r, tr_y + r,
                                fill="#EF4444", outline="#DC2626", width=1, tags=("pol_ctrl", "pol_del", "pol_del_oval"))
        self.canvas.create_text(tr_x, tr_y, text="✕", font=("Segoe UI", 8, "bold"),
                                fill="#FFFFFF", tags=("pol_ctrl", "pol_del", "pol_del_txt"))

        # 2. Sol Üst: Mavi Döndür (🔄 - Basılı Tutup Çevir)
        self.canvas.create_oval(tl_x - r, tl_y - r, tl_x + r, tl_y + r,
                                fill="#3B82F6", outline="#2563EB", width=1, tags=("pol_ctrl", "pol_rot", "pol_rot_oval"))
    ...
    def render_canvas_polaroids(self):
        ...
        for idx, item in enumerate(self.note_images):
            ...
            if self.is_today:
                ...
                def _make_arch_pol_click(t_name, p):
                    def _on_arch_click(e):
                        now = time.time()
                        last_t = getattr(self, f"_pol_last_click_{t_name}", 0)
                        if now - last_t < 0.55:
                            cnt = getattr(self, f"_pol_click_cnt_{t_name}", 0) + 1
                        ...
                        if cnt >= 3:
                            setattr(self, f"_pol_click_cnt_{t_name}", 0)
                            self.open_full_image(p)
                    return _on_arch_click

                self.canvas.tag_bind(tag_name, "<Button-1>", _make_arch_pol_click(tag_name, img_path))
    ...
    def setup_drag_drop(self):
        """TkinterDnD ile sürükle-bırak desteğini bağlar."""
...
class SettingsWindow(ctk.CTkToplevel):
    ...
    def setup_sound_tab(self, theme):
        ...
        ctk.CTkButton(c1_row, text="► Dinle", width=75, height=32, corner_radius=10,
                      fg_color=theme["btn_primary"], hover_color=theme["btn_primary_hover"],
                      text_color=theme["text"], font=ctk.CTkFont(family="Arial", size=12, weight="bold"),
